...
/// <summary>
/// Custom data consumer that outputs test results to iOS console (NSLog).
...
internal sealed class DeviceTestReporter : IDataConsumer, IOutputDeviceDataProducer
{
    ...
    public string Description => "Reports test results to iOS console for device testing scenarios.";
    ...
    public async Task ConsumeAsync(IDataProducer dataProducer, IData value, CancellationToken cancellationToken)
    {
        ...
        switch (nodeState)
        {
            case InProgressTestNodeStateProperty:
                Console.WriteLine($"[{TAG}] ▶ Running: {testDisplayName}");
            ...
            case PassedTestNodeStateProperty:
                _passed++;
                Console.WriteLine($"[{TAG}] ✓ Passed:  {testDisplayName}");
            ...
            case FailedTestNodeStateProperty failedState:
                ...
                Console.WriteLine($"[{TAG}] ✗ Failed:  {testDisplayName}");
                Console.WriteLine($"[{TAG}]   Error:   {errorMessage}");
            ...
            case ErrorTestNodeStateProperty errorState:
                ...
                Console.WriteLine($"[{TAG}] ✗ Error:   {testDisplayName}");
                Console.WriteLine($"[{TAG}]   Message: {errMsg}");
            ...
            case SkippedTestNodeStateProperty:
                _skipped++;
                Console.WriteLine($"[{TAG}] ○ Skipped: {testDisplayName}");
            ...
            default:
                ...
                Console.WriteLine($"[{TAG}] ? Unknown state for: {testDisplayName} - {nodeState.GetType().Name}");
                break;
        }
    }
